...
bonus. Ошибка окружения
Перед первым запуском, после запуска webpack-dev-server получил ошибку webpack'a несмотря на то, что версия webpack обновлена до 4.16.1 и [оператор расширения для объектов находится в final proposals](https://github.com/tc39/proposals/blob/master/finished-proposals.md). 
```
