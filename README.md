...
## Опционально. Цвет кластеров с исправными станциями
В задании указано:
> Неисправные станции обозначаются на карте красным цветом, исправные — синим.

Но не сказано про цвета кластеров. Предполагаю, что необходимо единое цветовое обозначение для исправных станций и кластеров из них образующихся для улучшения воспрития информации:
...
```
![9](https://pp.userapi.com/c849528/v849528576/29d59/m4Lv4y0t-DQ.jpg)
...
```
![10](https://pp.userapi.com/c849528/v849528576/29d68/rszZTVdN9aM.jpg)
